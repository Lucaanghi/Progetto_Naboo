...
public class NotizieController implements Initializable {
    ...
    public void rimuoviNotizia(ActionEvent event) throws IOException {
        ...
        session.createQuery("DELETE org.example.notizie.Notizia WHERE id = '" + lable_rimuovi_per_id.getText() + "'").executeUpdate();
    ...
    public void rimuoviNotiziePerData(ActionEvent event) {
        Session session = HibernateUtil.getSessionAnnotationFactory().openSession();
        Transaction tx = session.beginTransaction();
        session.createQuery("DELETE org.example.notizie.Notizia WHERE timestamp >= '" + lable_rimuovi_per_data_inizio.getText() + "' AND timestamp <= '" + lable_rimuovi_per_data_fine.getText() + "'").executeUpdate();
    ...
    public void rimuoviNotiziePerSquadra(ActionEvent event) {
        Session session = HibernateUtil.getSessionAnnotationFactory().openSession();
        Transaction tx = session.beginTransaction();
        session.createQuery("DELETE org.example.notizie.Notizia WHERE squadra = '" + lable_rimuovi_per_squadra.getText() + "'").executeUpdate();
    ...
    public void caricaTabellaNotizie(Session session, Transaction tx){
        Query<Notizia> query = session.createQuery("FROM org.example.notizie.Notizia", Notizia.class);
