...
public class CommentiController implements Initializable {
    ...
    public void rimuoviCommento(ActionEvent event) throws IOException {
        ...
        session.createQuery("DELETE org.example.commenti.Commento WHERE id = '" + lable_rimuovi_per_id.getText() + "'").executeUpdate();
    ...
    public void rimuoviCommentoPerNotizia(ActionEvent event) {
        Session session = HibernateUtil.getSessionAnnotationFactory().openSession();
        Transaction tx = session.beginTransaction();
        session.createQuery("DELETE org.example.commenti.Commento WHERE FK_notizia = " + lable_rimuovi_per_notizia.getText()).executeUpdate();
    ...
    public void rimuoviCommentoPerUtente(ActionEvent event) {
        Session session = HibernateUtil.getSessionAnnotationFactory().openSession();
        Transaction tx = session.beginTransaction();
        session.createQuery("DELETE org.example.commenti.Commento WHERE FK_utente = " + lable_rimuovi_per_utente.getText()).executeUpdate();
    ...
    public void caricaTabellaCommenti(Session session, Transaction tx){
        Query<Commento> query = session.createQuery("FROM org.example.commenti.Commento", Commento.class);
